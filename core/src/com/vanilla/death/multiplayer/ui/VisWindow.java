...
public class VisWindow extends Window {
    ...
    public VisWindow (String title) {
        this(title, true);
        getTitleLabel().setAlignment(com.kotcrab.vis.ui.VisUI.getDefaultTitleAlign());
    }

    public VisWindow (String title, boolean showWindowBorder) {
        super(title, com.kotcrab.vis.ui.VisUI.getSkin(), showWindowBorder ? "default" : "noborder");
        getTitleLabel().setAlignment(com.kotcrab.vis.ui.VisUI.getDefaultTitleAlign());
    }

    public VisWindow (String title, String styleName) {
        super(title, com.kotcrab.vis.ui.VisUI.getSkin(), styleName);
        getTitleLabel().setAlignment(com.kotcrab.vis.ui.VisUI.getDefaultTitleAlign());
    }
